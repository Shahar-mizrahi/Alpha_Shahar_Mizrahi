...
for i, combination in enumerate(all_combinations):
    ...
    for j in range(NUM_OF_ITERATIONS):
        ...
        svm = ee.Classifier.libsvm(decisionProcedure= None, svmType= 'EPSILON_SVR', kernelType= 'RBF', shrinking= True, cost = 100, lossEpsilon = 0.1 ,terminationEpsilon = 0.001, gamma= 0.5).setOutputMode('REGRESSION')
