...
training_datasets = [data_2019_2020, data_2019_2021, data_2020_2021]
testing_datasets = [data_2021, data_2020, data_2019]
...
for i, combination in enumerate(all_combinations):
    ...
    for training, testing in zip(training_datasets, testing_datasets):
        ...
        # Define a Gradient Boosting Regressor and train it on the training data
        # gradient_boosting = ee.Classifier.smileGradientTreeBoost(numberOfTrees=1000, shrinkage=0.1, samplingRate=0.85, maxNodes=8, loss='LeastAbsoluteDeviation', seed=None).setOutputMode('REGRESSION')

        gradient_boosting = ee.Classifier.smileGradientTreeBoost(numberOfTrees= 200, shrinkage= 0.1, samplingRate= 0.85, maxNodes= 40, loss= 'LeastAbsoluteDeviation', seed= 42).setOutputMode('REGRESSION')
        trained_model = gradient_boosting.train(
...
csv_output_path = r"C:\Users\Cyber_User\Desktop\alpha_codes\code_results/GB_best_combination_results.csv"
