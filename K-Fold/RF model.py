...
for i, combination in enumerate(all_combinations):
    ...
    for training, testing in zip(training_datasets, testing_datasets):
        ...
        variables_per_split = int(len(combination)) #  ** 0.5            variablesPerSplit=variables_per_split,                                                         , seed=42
        random_forest = ee.Classifier.smileRandomForest(numberOfTrees=1000, variablesPerSplit=variables_per_split, minLeafPopulation = 3, maxNodes = 8, bagFraction = 0.85).setOutputMode('REGRESSION')
    ...
    print(f"CSV file has been saved to: {csv_output_path2}")
...
csv_output_path = r"C:\Users\Cyber_User\Desktop\alpha_codes\code_results/RF_best_combination_results.csv"
